...
namespace mur128m_scanner{
  const trans_table::Elem<Lexem_code> keywords_jump_table[] = {
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::RegisterBp,    0}, // 1: bp
    ...
    {const_cast<char32_t*>(U"do"),    Lexem_code::Id,           85}, // 73: fl...
    {const_cast<char32_t*>(U"r"),     Lexem_code::Id,           87}, // 74: fo...
    {const_cast<char32_t*>(U"a"),     Lexem_code::Id,           88}, // 75: fr...
	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF0,           0}, // 76: f0...
 	{const_cast<char32_t*>(U"0123456789"),     Lexem_code::KwRegF1,  107}, // 76: f1...
 	{const_cast<char32_t*>(U"0123456789"),     Lexem_code::KwRegF2,  115}, // 77: f2...
 	{const_cast<char32_t*>(U"01"),     Lexem_code::KwRegF3,          125}, // 78: f3...
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF4,           0}, // 79: f4
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF5,           0}, // 80: f5
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF6,           0}, // 81: f6
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF7,           0}, // 82: f7
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF8,           0}, // 83: f8
 	{const_cast<char32_t*>(U""),     Lexem_code::KwRegF9,           0}, // 84: f9
    {const_cast<char32_t*>(U"z1"),    Lexem_code::Id,           80}, // 85: fld...
    {const_cast<char32_t*>(U"a"),     Lexem_code::Id,           82}, // 86: flo...
    {const_cast<char32_t*>(U"m"),     Lexem_code::Id,           83}, // 87: for...
    {const_cast<char32_t*>(U"c"),     Lexem_code::Id,            0}, // 88: fra...
    {const_cast<char32_t*>(U""),      Lexem_code::KwFld1,        0}, // 89: fld1
    {const_cast<char32_t*>(U""),      Lexem_code::KwFldz,        0}, // 90: fldz
    {const_cast<char32_t*>(U"t"),     Lexem_code::Id,           85}, // 91: floa...
    {const_cast<char32_t*>(U"a"),     Lexem_code::Id,           86}, // 92: form...
    {const_cast<char32_t*>(U""),      Lexem_code::KwFrac,        0}, // 93: frac
    {const_cast<char32_t*>(U"1368"),  Lexem_code::Id,           87}, // 94: float...
    {const_cast<char32_t*>(U"t"),     Lexem_code::Id,           91}, // 95: forma...
    {const_cast<char32_t*>(U"2"),     Lexem_code::Id,           92}, // 96: float1...
    {const_cast<char32_t*>(U"2"),     Lexem_code::Id,           93}, // 97: float3...
    {const_cast<char32_t*>(U"4"),     Lexem_code::Id,    	94}, // 98: float6...
    {const_cast<char32_t*>(U"0"),     Lexem_code::Id,   	95}, // 99: float8...
    {const_cast<char32_t*>(U""),      Lexem_code::KwFormat,      0}, // 100: format
    {const_cast<char32_t*>(U"8"),     Lexem_code::Id,           96}, // 101: float12...
    {const_cast<char32_t*>(U""),      Lexem_code::KwFloat32,     0}, // 101: float32
    {const_cast<char32_t*>(U""),      Lexem_code::KwFloat64,     0}, // 103: float64
    {const_cast<char32_t*>(U""),      Lexem_code::KwFloat80,     0}, // 104: float80
    {const_cast<char32_t*>(U""),      Lexem_code::KwFloat128,    0}, // 105: float128
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF11,      0}, // 106: f11
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF12,      0}, // 107: f12
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF13,      0}, // 108: f13
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF14,      0}, // 109: f14
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF15,    0}, // 110: f15
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF16,    0}, // 111: f16
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF17,    0}, // 112: f17
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF18,    0}, // 113: f18
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF19,    0}, // 114: f19
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF20,    0}, // 115: f20
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF21,    0}, // 116: f21
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF22,    0}, // 117: f22
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF23,    0}, // 118: f23
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF24,    0}, // 119: f24
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF25,    0}, // 120: f25
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF26,    0}, // 121: f26
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF27,    0}, // 122: f27
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF28,    0}, // 123: f28
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF29,    0}, // 124: f29
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF30,    0}, // 125: f30
    {const_cast<char32_t*>(U""),      Lexem_code::KwRegF31,    0}, // 126: f31

    {const_cast<char32_t*>(U"m"),     Lexem_code::Id,           98}, // 97: j...
    {const_cast<char32_t*>(U"p"),     Lexem_code::Id,           99}, // 98: jm...
    {const_cast<char32_t*>(U"glnprsz"),Lexem_code::KwJmp,   100}, // 99: jmp...
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpr,        0}, // 104: jmpr
    {const_cast<char32_t*>(U"r"),     Lexem_code::Id,          111}, // 105: jmps...
    {const_cast<char32_t*>(U"r"),     Lexem_code::Id,          112}, // 106: jmpz...
    {const_cast<char32_t*>(U"r"),     Lexem_code::KwJmpge,     113}, // 107: jmpge...
    {const_cast<char32_t*>(U"r"),     Lexem_code::KwJmple,     114}, // 108: jmple...
    {const_cast<char32_t*>(U"r"),     Lexem_code::KwJmpnz,     115}, // 109: jmpnz...
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmppr,       0}, // 110: jmppr
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpsr,       0}, // 111: jmpsr
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpzr,       0}, // 112: jmpzr
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpger,      0}, // 113: jmpger
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpler,      0}, // 114: jmpler
    {const_cast<char32_t*>(U""),      Lexem_code::KwJmpnzr,      0}, // 115: jmpnzr
    ...
    {const_cast<char32_t*>(U"n"),     Lexem_code::KwOr,        143}, // 142: or...
    {const_cast<char32_t*>(U""),      Lexem_code::KwOrn,         0}, // 143: orn...

    {const_cast<char32_t*>(U"o"),     Lexem_code::Id,          145}, // 144: x...
    {const_cast<char32_t*>(U"r"),     Lexem_code::Id,          146}, // 145: xo...
    {const_cast<char32_t*>(U"n"),     Lexem_code::KwXor,       147}, // 146: xor...
    {const_cast<char32_t*>(U""),      Lexem_code::KwXorn,        0}, // 147: xorn...
    ...
    {const_cast<char32_t*>(U"s"),     Lexem_code::KwLshift,    154}, // 153: lshift...
    {const_cast<char32_t*>(U""),      Lexem_code::KwLshifts,     0}, // 154: lshifts

    {const_cast<char32_t*>(U"o"),     Lexem_code::Id,          156}, // 155: n...
    {const_cast<char32_t*>(U"t"),     Lexem_code::Id,          157}, // 156: no...
    {const_cast<char32_t*>(U""),      Lexem_code::KwNot,         0}, // 157: not...
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwTrap,        0}, // 161: trap
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetz,        0}, // 170: retz
    {const_cast<char32_t*>(U"e"),     Lexem_code::Id,          180}, // 171: retg...
    {const_cast<char32_t*>(U""),      Lexem_code::KwReti,        0}, // 172: reti
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetl,        0}, // 173: retl
    {const_cast<char32_t*>(U"z"),     Lexem_code::KwRetn,      181}, // 174: retn...
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetp,        0}, // 175: retp
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetge,       0}, // 180: retge
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetnz,     175}, // 181: retnz...
    {const_cast<char32_t*>(U"e"),     Lexem_code::KwRetag,     192}, // 182: retag..
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetai,       0}, // 183: retai
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetap,       0}, // 184: retap
    {const_cast<char32_t*>(U"e"),     Lexem_code::KwRetal,     193}, // 185: retal...
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetaz,       0}, // 186: retaz
    {const_cast<char32_t*>(U"z"),     Lexem_code::KwRetan,     194}, // 187: retan...
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwRets,        0}, // 191: rets
    {const_cast<char32_t*>(U""),      Lexem_code::KwRege,        0}, // 192: retge
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetale,      0}, // 193: retale
    {const_cast<char32_t*>(U""),      Lexem_code::KwRetanz,      0}, // 194: retanz
    {const_cast<char32_t*>(U"l"),     Lexem_code::Id,          201}, // 195: readab..
    {const_cast<char32_t*>(U""),      Lexem_code::KwRoundg,      0}, // 196: roundg
    {const_cast<char32_t*>(U""),      Lexem_code::KwRoundn,      0}, // 197: roundn
    {const_cast<char32_t*>(U""),      Lexem_code::KwRoundl,      0}, // 198: roundl
    {const_cast<char32_t*>(U""),      Lexem_code::KwRoundt,      0}, // 199: roundt
    {const_cast<char32_t*>(U"s"),     Lexem_code::KwRshift,    202}, // 200: rshift
    {const_cast<char32_t*>(U"e"),     Lexem_code::Id,          203}, // 201: readable
    {const_cast<char32_t*>(U""),      Lexem_code::KwRshifts,     0}, // 202: rshifts
    ...
    {const_cast<char32_t*>(U""),      Lexem_code::KwPop,         0}, // 220: pop
    {const_cast<char32_t*>(U""),      Lexem_code::KwPush,        0}, // 221: push
